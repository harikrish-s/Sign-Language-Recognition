...
def	process(image):
	...
	if results.multi_hand_landmarks:
		...
		if cleaned_landmark:
			...
			# print("Queue 1 Inside	Detection -	", result_queue.queue)
			# print("Queue 2 - Inside Detection	", acomp_queue.queue)
...
def	ttsgtts():
	# st.spinner(text="Audio in Progress..")
	sound_file = BytesIO()
	tts	= gTTS(s, lang='en')
...
if webrtc_ctx.state.playing:
	...
	while True:
		try:
			...
			print("Split Res - ", splitres)
			print("Auto	Complete List  -", temp2)
			...
			if (queue2 == "ACOMP" and result[-1].isdigit() == True and int(result[-1]) <= 4):
				...
				# print("Autoges = ", autoges)
				nowrds = result.split()
				# print("Queue 1 inside	Acomp -	", result_queue.queue)
				# print("Queue 2 inside	Acomp -	", acomp_queue.queue)
